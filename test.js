...
describe('createSlackMessage', () => {
  it('should create a slack message', () => {
    ...
    attachment.fields.should.have.length(1);
  ...
  it('should create a slack message with images', () => {
    ...
    let attachment = message.attachments[0];
    attachment.fields.should.have.length(3);
    attachment.fields[1].value.should.equal('image-1');
    attachment.fields[2].value.should.equal('image-2');
  });
});
